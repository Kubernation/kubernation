...
use kubernation_core::state::world::{City, CoastKind, Continent, Province, Region, WorldModel};
...
fn draw_island(
    ...
    area: Rect,
    cam: (u16, u16),
    isl: &kubernation_core::state::world::Island,
    ctx: &RenderCtx,
) {
    let theme = ctx.theme;
...
mod tests {
    ...
    fn demo_world() -> (kubernation_core::state::observed::ObservedWorld, fx::Seeds) {
    ...
    fn big_world() -> (kubernation_core::state::observed::ObservedWorld, fx::Seeds) {
